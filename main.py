...
if __name__ == "__main__":
    ...
    version, debug, dataset_path, output_path = utils.read_config_file(config_file_name)
  
    image_file_names = utils.get_all_file_names_in_folder(dataset_path, image_file_type)
